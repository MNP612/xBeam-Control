...
IMGAE_PATH = '/Users/Marvin/Desktop/' #r'C:\Users\Jet Squad\Pictures\Camera Roll/'
...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.button_stop["command"] =  lambda : [controller.command('ST'), ser.write(('ST\r').encode()), self.motor5_running.set("")]
        ...
        self.motor1_label = tk.Label(self, text='PIEZO 1', width=15)
        ...
        self.motor5_button["command"] = lambda : [self.subtract(), self.send_stepper_cmd("FL" + str(self.motor5_input.get()))]
        ...
        self.motor5_button["command"] = lambda : [self.add(), self.send_stepper_cmd("FL-" + str(self.motor5_input.get()))]
        self.motor5_button["width"] = 10
